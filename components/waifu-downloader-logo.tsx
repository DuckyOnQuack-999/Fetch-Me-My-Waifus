...
export function WaifuDownloaderLogo({ className, size = "md", animated = true }: WaifuDownloaderLogoProps) {
  ...
  return (
    <LogoComponent
      className={cn(
        "relative flex items-center justify-center rounded-lg bg-gradient-to-br from-pink-400 to-red-500 text-white shadow-lg",
        sizeClasses[size],
        className,
      )}
      {...animationProps}
    ...
    >
      {/* Background Circle */}
      <motion.div
        className="absolute inset-0 rounded-full bg-gradient-to-br from-pink-400 via-red-400 to-pink-500 shadow-lg"
